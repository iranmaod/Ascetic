 ...
 * Logo
 */
if ( ! function_exists( 'boldthemes_get_logo' ) ) {
	function boldthemes_get_logo( $type = 'header' ) {
		...
		if ( $logo != '' && $logo != ' ' ) {
			if ( $type == 'header' ) {
				$output = '<a href="' . esc_url( $home_link ) . '"><img class="btMainLogo" data-hw="' . esc_attr( $hw ) . '" src="' . esc_attr( $logo ) . '" alt="' . esc_attr( get_bloginfo( 'name' ) ) . '">';
				if ( $alt_logo != '' && $alt_logo != ' ' ) $output .= '<img class="btAltLogo" src="' . esc_attr( $alt_logo ) . '" alt="' . esc_attr( get_bloginfo( 'name' ) ) . '">';
				$output .= '</a>';
			} else if ( $type == 'footer' ) {
				$output = '<a href="' . esc_url( $home_link ) . '"><img src="' . esc_attr( $logo ) . '" alt="' . esc_attr( get_bloginfo( 'name' ) ) . '"></a>';
			} else if ( $type == 'preloader' ) {
				$output = '<img class="preloaderLogo" src="' . esc_attr( $logo ) . '" alt="' . esc_attr( get_bloginfo( 'name' ) ) . '" data-alt-logo="' . esc_attr( $alt_logo ) . '">';
			}
		} else {
			$output = '<a href="' . esc_url( $home_link ) . '" class="btTextLogo">' . esc_html( get_bloginfo( 'name' ) ) . '</a>';
		}
	return $output;
	}
}
