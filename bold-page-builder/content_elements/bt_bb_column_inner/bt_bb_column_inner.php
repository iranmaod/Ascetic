...
class bt_bb_column_inner extends BT_BB_Element {
	...
	function map_shortcode() {		
		...
		bt_bb_map( $this->shortcode, array( 'name' => esc_html__( 'Inner Column', 'ajani' ), 'description' => esc_html__( 'Inner Column element', 'ajani' ), 'width_param' => 'width', 'container' => 'vertical', 
			...
			'params' => array(
				...
				array( 'param_name' => 'opacity', 'type' => 'textfield', 'heading' => esc_html__( 'Opacity (deprecated)', 'ajani' ), 'group' => esc_html__( 'Design', 'ajani' ) ),
